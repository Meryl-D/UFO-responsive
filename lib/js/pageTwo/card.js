...
function renderChart(stringYearData) {
  var maxRounded = (0, _ufoData.getMaxAmountRounded)(stringYearData);
  var dateYearData = (0, _ufoData.getDateYearData)(stringYearData);
  var entriesPerYear = (0, _ufoData.getEntriesPerYear)(stringYearData); // Défini les dimensions et marges du graphe
